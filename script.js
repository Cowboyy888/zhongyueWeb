...
var i18nData = {
  zh: {
    ...
    'fac-desc': '坐落于广东省工业园区，占地超26,000㎡的现代化钢铁生产基地。<br/>全封闭厂区、智能安防、ISO认证车间——我们的每一批产品都诞生于此。',
    ...
    'del-card-2-desc': '覆盖广东、华南及全国各省市工地，准时交付有保障',
    ...
    'footer-about': '专注焊接钢筋网研发、生产与销售，服务建筑、基础设施及工业领域，出口60余个国家，1998年成立至今始终如一。',
  ...
  en: {
    ...
    'hero-desc': 'Zhongyu Steel — 10+ years of precision steel mesh manufacturing. Serving 60+ countries worldwide.',
    ...
    'fac-subtitle': 'Zhongyu Steel · World-Class Factory',
    'fac-desc': 'A modern steel production base covering over 26,000㎡ in Guangdong\'s industrial zone.<br/>Fully enclosed campus, smart security, ISO-certified workshops — every batch is born here.',
    ...
    'fc5-overlay': 'Zhongyu Steel · Factory Overview', 'fc5-title': '26,000㎡ Modern Factory',
    ...
    'why-tag': 'Why Choose Us', 'why-title': 'Zhongyu Steel <em>Six Advantages</em>',
    'why-lead': 'Six core reasons why top global engineers and contractors choose Zhongyu Steel.',
    ...
    'testi-1-text': 'Zhongyu Steel\'s mesh weld strength and dimensional tolerances fully met our design requirements. Lead time was just 12 days, QC reports were complete, and inspection passed on the first try.',
    'testi-1-name': 'Li Jianming / Procurement Director',
    'testi-2-text': 'We switched all floor slab reinforcement to Zhongyu Steel two years ago. Compared to manual tying, construction efficiency improved by 40%, costs dropped 18%, and quality is more consistent.',
    'testi-2-name': 'Chen Xiaofang / Supply Chain Manager',
    'testi-3-text': 'Custom-shape mesh for tunnel lining was fabricated per our drawings. The Zhongyu technical team supported us throughout, achieving the required precision. We will continue the partnership.',
    ...
    'del-card-2-desc': 'Covers Guangdong, South China, and worksites across all provinces — guaranteed on-time delivery',
  ...
  km: {
    'topbar-addr': 'CJJG+HHH, ខុមត្រពែងកុង, កម្ពុជា',
    'topbar-hours': 'រាល់ថ្ងៃ: ០៨:០០ - ១៧:០០',
    'topbar-cta': 'សុំតម្លៃ',
    'nav-home': 'ទំព័រដើម', 'nav-about': 'អំពីយើង', 'nav-facility': 'រោងចក្រ',
    'nav-products': 'ផលិតផល', 'nav-process': 'ដំណើរការ', 'nav-factory': 'ឧបករណ៍',
    'nav-delivery': 'ដឹកជញ្ជូន', 'nav-why': 'មូលហេតុ', 'nav-contact': 'ទំនាក់ទំនង',
    'nav-why-long': 'គុណសម្បត្តិរបស់យើង', 'nav-cta': 'សុំតម្លៃ',
    'hero-badge': 'អ្នកផលិតតារភ្ជាប់ដែកជំនាញ · ចាប់ផ្តើម ២០០២',
    'hero-h1': 'សាងសង់ <em>កម្លាំង</em><br/>រចនាសម្ព័ន្ធ <em>ប្រើបានយូរ</em>',
    'hero-tagline': 'កសាងកម្លាំង។ រូបរាងអនាគត។',
    'hero-desc': 'ក្រុមហ៊ុន Zhongyue Steel — ជំនាញផលិតតារភ្ជាប់ដែកជាង ១០ ឆ្នាំ។ បម្រើជាង ៦០ ប្រទេស។',
    'hero-btn-products': 'មើលផលិតផល', 'hero-btn-process': 'ដំណើរការ', 'hero-btn-contact': 'ទំនាក់ទំនង',
    'feat-1-title': 'ផលិតផលគុណភាពខ្ពស់', 'feat-1-desc': 'បញ្ជាក់ ISO 9001 ជាមួយរបាយការណ៍ QC ពេញលេញ',
    'feat-2-title': 'បច្ចេកវិទ្យាទំនើប', 'feat-2-desc': 'ម៉ាស៊ីនជ្រួញស្វ័យប្រវត្តិ ផលិតបាន ៨០០ តោន/ថ្ងៃ',
    'feat-3-title': 'ដំណើរការជឿជាក់', 'feat-3-desc': 'ជំនាញជាង ១០ ឆ្នាំ បម្រើជាង ៦០ ប្រទេស',
    'feat-4-title': 'ការអភិវឌ្ឍប្រកបដោយនិរន្តរភាព', 'feat-4-desc': 'ដំណើរការផលិតប្រកបស្តង់ដារបរិស្ថានអន្តរជាតិ',
    'meta-years': 'ឆ្នាំបទពិសោធ', 'meta-cap': 'ផលិតប្រចាំថ្ងៃ (តោន)', 'meta-countries': 'ប្រទេសនាំចេញ', 'meta-retention': 'អ្នកប្រើប្រាស់ស្ថិតស្ថេរ',
    'spec-custom-val': 'ទំហំតាមការបញ្ជា', 'spec-strength-val': 'កម្លាំងខ្ពស់',
    'tick-1': 'តារភ្ជាប់ដែកជ្រួញ', 'tick-2': 'ដែករឹង Carbon Steel', 'tick-3': 'តាមតម្រូវការ', 'tick-4': 'ផ្ដល់ផលិតផលជាង ៦០+ ប្រទេស', 'tick-5': 'ចែកចាយទាន់ពេល ៩៩%',
    'tl-tag': 'ដំណើរការផលិត', 'tl-title': 'ពី <em>វត្ថុធាតុ</em> ដល់ <em>ផលិតផលសម្រេច</em>',
    'tl-lead': 'ប្រាំពីរជំហានដំណើរការ ជាមួយការតាមដានគុណភាពពេញលេញ — ធានា batch គ្រប់ស្រទាប់',
    'step-1': 'វត្ថុធាតុ', 'step-1-sub': 'Steel Wire Rod',
    'step-2': 'ត្រង់ &amp; កាត់', 'step-2-sub': 'Wire Straightening',
    'step-3': 'ជ្រួញស្វ័យប្រវត្តិ', 'step-3-sub': 'Auto Welding',
    'step-4': 'កាត់ &amp; ដំណើរការ', 'step-4-sub': 'Cutting &amp; Forming',
    'step-5': 'ត្រួតពិនិត្យ QC', 'step-5-sub': 'QC Inspection',
    'step-6': 'វេចខ្ចប់', 'step-6-sub': 'Packaging',
    'step-7': 'ចែកចាយ', 'step-7-sub': 'Global Delivery',
    'about-tag': 'អំពី Zhongyue Steel', 'about-title': 'គុណភាព <em>ខ្ពស់</em><br/>គួរជឿជាក់',
    'about-badge-text': 'ឆ្នាំ<br/>ជំនាញ',
    'about-year-label': 'បង្កើត · ឆ្នាំបង្កើត',
    'about-live-label': 'ដំណើរការផលិតផ្ទាល់',
    'about-lead': 'បង្កើតក្នុងឆ្នាំ 2002 ក្រុមហ៊ុន Zhongyue Steel ប្តេជ្ញាខ្លួននឹងការស្រាវជ្រាវ និងផលិតតារភ្ជាប់ដែក ជាមួយប្រព័ន្ធជ្រួញស្វ័យប្រវត្តិ ប្រព័ន្ធកាត់ច្បាស់លាស់ និងការត្រួតពិនិត្យគុណភាព — យើងបានក្លាយជាអ្នកផលិតតារភ្ជាប់ដែកដែលទទួលបានការទុកចិត្តក្នុងប្រទេសកម្ពុជា។',
    'about-f1-title': 'ការបញ្ជាក់ ISO 9001:2015',
    'about-f1-desc': 'ផលិតផលគ្រប់ batch ភ្ជាប់ជាមួយរបាយការណ៍ test ពេញលេញ រួមមានកម្លាំងជ្រួញ ភាពត្រឹមត្រូវ និងភាពច្បាស់លាស់ mesh',
    'about-f2-title': 'ខ្សែផលិតស្វ័យប្រវត្តិ',
    'about-f2-desc': 'ម៉ាស៊ីនជ្រួញ mesh ស្វ័យប្រវត្តិ ±0.5mm ភាពត្រឹមត្រូវ ដំណើរការ 24/7 ផលិតបាន ៨០០ តោន/ថ្ងៃ',
    'about-f3-title': 'ការផ្គត់ផ្គង់ &amp; ដឹកជញ្ជូនអន្តរជាតិ',
    'about-f3-desc': 'ផ្ដល់ជូនជាង 60 ប្រទេស ជាមួយការគ្រប់គ្រងគយ ការដឹក និងការធានារ៉ាប់រង',
    'fac-eyebrow-text': 'រោងចក្ររបស់យើង',
    'fac-subtitle': 'Zhongyue Steel · រោងចក្រទំនើប',
    'fac-desc': 'មូលដ្ឋានផលិតដែកទំនើប ស្ថិតលើ 26,000㎡ ក្នុងប្រទេសកម្ពុជា<br/>ការគ្រប់គ្រងបរិស្ថានបែបប្រពៃណី ប្រព័ន្ធសន្តិសុខ ការបញ្ជាក់ ISO',
    'fstat-1': 'ផ្ទៃដីសរុប', 'fstat-2-unit': 'ខ្សែ', 'fstat-2': 'ខ្សែផលិតស្វ័យប្រវត្តិ',
    'fstat-3-unit': 'តោន/ថ្ងៃ', 'fstat-3': 'ផលិតកម្មអតិបរមា', 'fstat-4': 'ការបញ្ជាក់ ISO 9001',
    'fac-cta-text': 'ទស្សនកិច្ចរោងចក្រ',
    'partners-label': 'អ្នកប្រើប្រាស់ &amp; ដៃគូ',
    'products-tag': 'ផលិតផលរបស់យើង', 'products-title': 'ផលិតផល <em>ចម្បងប្រាំ</em>',
    'products-lead': 'ផលិតផលតាមឡានឡស់ ភ្ជាប់ជាមួយការបញ្ជាក់គុណភាព ស្តង់ ចន្លោះ mesh ត្រូវតាម GB, EN, ASTM',
    'p1-num-label': 'ផលិតផលលក់ដាច់', 'p1-cat': 'Welded Mesh', 'p1-name': 'តារភ្ជាប់ដែកជ្រួញ<br/>/ ក្រឡសំណង់',
    'p1-desc': 'តារភ្ជាប់ដែកជ្រួញស្តង់ដារ ស្តង់ 4-12mm ចន្លោះ 100-200mm ទំហំអតិបរមា 6x2.4m',
    'p2-cat': 'Floor Mesh', 'p2-name': 'តារភ្ជាប់ជាន់',
    'p2-desc': 'រចនាសម្ព័ន្ធសម្រាប់ Slab ការចាក់ Concrete ស្តង់ 6-10mm ចន្លោះ 150mm',
    'p3-cat': 'Fence Mesh', 'p3-name': 'តារភ្ជាប់ Fence',
    'p3-desc': 'តារភ្ជាប់ Fence ប្រើប្រាស់ស្ទើរគ្រប់ទីកន្លែង ស្តង់ 3-6mm ចន្លោះ 50-100mm Galvanized ឬ Powder Coat',
    'p4-cat': 'ផ្ដាល់', 'p4-name': 'តារភ្ជាប់ ផ្ដាល់',
    'p4-desc': 'តារភ្ជាប់ L, T, Curved ផ្ដាល់ សម្រាប់ស្ពាន វណ្ឌូ និងសំណង់ស្មុគស្មាញ',
    'p5-cat': 'វត្ថុធាតុ', 'p5-name': 'ខ្សែដែក / Rod',
    'p5-desc': 'ខ្សែដែក Cold-drawn និង Rod Hot-rolled ស្តង់ 3-12mm សម្រាប់ម៉ាស៊ីនជ្រួញ',
    'p-quote': 'សុំតម្លៃ <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>',
    'factory-tag': 'រោងចក្ររបស់យើង', 'factory-title': 'ឧបករណ៍ទំនើប <em>ផលិតប្រុងប្រយ័ត្ន</em>',
    'factory-lead': 'ខ្សែជ្រួញ mesh ស្វ័យប្រវត្តិ · ឧបករណ៍ Cold-drawn · ប្រព័ន្ធ QC<br/>ផលិតកម្មប្រចាំឆ្នាំលើស ២០ ម៉ឺនតោន',
    'factory-feature-img-label': 'ម៉ាស៊ីនជ្រួញ Multi-Point ស្វ័យប្រវត្តិ · 48 ក្បាល',
    'factory-feature-tag': 'ឧបករណ៍ចម្បង', 'factory-feature-title': 'ខ្សែផលិត<br/><em>Mesh ស្វ័យប្រវត្តិ</em>',
    'factory-feature-desc': 'ម៉ាស៊ីនជ្រួញ mesh ស្វ័យប្រវត្តិ 48 ក្បាលដំណើរការ — ផលិតបាន 60 ផ្ទាំង/ម៉ោង ប្រព័ន្ធ Pneumo-hydraulic ធានាកម្លាំងជ្រួញ GB/T',
    'fl-1-label': 'ល្បឿនជ្រួញ', 'fl-1-val': '60 ផ្ទាំង/ម៉ោង',
    'fl-2-label': 'សម្ពាធជ្រួញ', 'fl-2-val': 'Pneumo-hydraulic ±2% ភាពត្រឹមត្រូវ',
    'fl-3-label': 'ចន្លោះអាចកំណត់', 'fl-4-label': 'ជួរស្តង់ខ្សែ',
    'fc1-overlay': 'ក្បាលជ្រួញ Pneumo-Hydraulic', 'fc1-title': 'ជួរក្បាលជ្រួញច្បាស់លាស់', 'fc1-desc': 'ក្បាល Pneumo-hydraulic 48 ច្បាស់ ធានាគុណភាពជ្រួញគ្រប់ចំណុច',
    'fc2-overlay': 'ប្រព័ន្ធបំពេញស្វ័យប្រវត្តិ', 'fc2-title': 'បំពេញចំហឹង · ត្រឹមតាំងច្បាស់លាស់', 'fc2-desc': 'ប្រព័ន្ធបំពេញ Servo-driven ត្រឹមតាំង ±0.5mm',
    'fc3-overlay': 'ខ្សែ Cold-draw', 'fc3-title': 'Cold Draw · ផលិតខ្សែ', 'fc3-desc': 'ម៉ាស៊ីន Cold-draw 8 ក្បាល ផ្គត់ផ្គង់ខ្សែដោយស្វ័យប្រវត្តិ',
    'fc4-overlay': 'ប្រព័ន្ធ Payoff ស្វ័យប្រវត្តិ', 'fc4-title': 'ជើង Payoff ខ្សែស្ពូន', 'fc4-desc': 'ជើង Payoff ទំហំ 3 តោន ជាមួយការគ្រប់គ្រងសម្ពាធ',
    'fc5-overlay': 'Zhongyue Steel · ទិដ្ឋភាពរោងចក្រ', 'fc5-title': '26,000㎡ រោងចក្រទំនើប',
    'fc5-desc': 'Crane 10 តោន ខ្សែ Cold-draw → ត្រង់ → ជ្រួញ → កាត់ → ត្រួតពិនិត្យ → ស្តុក ផលិតប្រចាំថ្ងៃ 800 តោន',
    'fact-1': 'ផលិតប្រចាំថ្ងៃ (តោន)', 'fact-2': 'ប្រទេសនាំចេញ', 'fact-3': 'បុគ្គលិក', 'fact-4': 'ការបញ្ជាក់ ISO',
    'why-tag': 'ហេតុអ្វីត្រូវជ្រើសយើង', 'why-title': 'Zhongyue Steel <em>គុណសម្បត្តិប្រាំមួយ</em>',
    'why-lead': 'មូលហេតុប្រាំមួយចម្បង ដែលវិស្វករ និងអ្នកសំណង់នៅទូទាំងពិភពលោកជ្រើស Zhongyue Steel',
    'why-1-title': 'វិញ្ញាបនបត្រគុណភាព', 'why-1-desc': 'ផលិតផលគ្រប់ batch ភ្ជាប់ជាមួយរបាយការណ៍ test — ធានាតាមដានបាន',
    'why-2-title': 'ចែកចាយទាន់ពេល', 'why-2-desc': 'ព័ត៌មានស្ថានភាព 99% — ការបញ្ជាទិញធម្មតា 15 ថ្ងៃការងារ',
    'why-3-title': 'សេវាផ្ដាល់', 'why-3-desc': 'ស្តង់ ចន្លោះ ទំហំ mesh ផ្ដាល់ ជាមួយការគាំទ្រពីវិស្វករ',
    'why-4-title': 'តម្លៃរោងចក្រ', 'why-4-desc': 'គ្មានអ្នកម្ចាស់ — តម្លៃរោងចក្រប្រកួតប្រជែង អ្នកទិញ bulk ទទួលបន្ថែម',
    'why-5-title': 'ផ្គត់ផ្គង់អន្តរជាតិ', 'why-5-desc': 'ស្តុកពីដៃគូ 4 ទ្វីប ក្រុម export ដោះស្រាយ FOB, CIF',
    'why-6-title': 'គាំទ្របច្ចេកទេស 7×24', 'why-6-desc': 'Account manager ខ្លះ និងវិស្វករ online 24/7 ដោះស្រាយការប្រឹក្សា',
    'testi-tag': 'ការវាយតម្លៃ', 'testi-title': 'អ្វី <em>ដែលអ្នកប្រើប្រាស់និយាយ</em>',
    'testi-1-text': 'តារភ្ជាប់ដែករបស់ Zhongyue Steel មានកម្លាំងជ្រួញ និងភាពត្រឹមត្រូវ QC reports ពេញ ការត្រួតពិនិត្យបន្តបន្ទាប់',
    'testi-1-name': 'Li Jianming / នាយករការទិញ',
    'testi-2-text': 'ក្រោយពីប្រើ Zhongyue Steel — ប្រសិទ្ធភាព +40% ថ្លៃ -18% គុណភាពជឿជាក់',
    'testi-2-name': 'Chen Xiaofang / Supply Chain Manager',
    'testi-3-text': 'Mesh ផ្ដាល់ Tunnel Zhongyue ជួយបានពេញ ភាពត្រឹមត្រូវ ហើយនឹងបន្តសហការ',
    'testi-3-name': 'Wang Haitao / Equipment Engineer',
    'del-label': 'ចែកចាយទាន់ពេល', 'del-title': 'ដឹកជញ្ជូនប្រសិទ្ធភាព · <span>ទាន់ពេលវេលា</span>',
    'del-desc': 'ពីរោងចក្រទៅទីតាំងសំណង់ ដឹកជញ្ជូនតាមដានពេញលេញ ធានាតារភ្ជាប់ដែកបានដល់ទាន់ពេល',
    'del-badge-1': 'ចែកចាយ Bulk', 'del-card-1-title': 'LKW ពេញ · ផ្ទុកច្រើន', 'del-card-1-desc': 'LKW Flatbed ផ្ទុក Mesh 20-30 តោន/គ្រប់',
    'del-badge-2': 'អន្តរជាតិ', 'del-card-2-title': 'ក្រុម Fleet · តាមដានពេញ', 'del-card-2-desc': 'គ្របដណ្ដប់ Cambodia និងប្រទេសជិតខាង ចែកចាយទាន់ពេល',
    'del-stat-1-unit': 'ម៉ោង', 'del-stat-1-label': 'ចែកចាយក្រោយការបញ្ជា',
    'del-stat-2-unit': 'តោន/LKW', 'del-stat-2-label': 'ផ្ទុកអតិបរមា',
    'del-stat-3-unit': '+ ប្រទេស', 'del-stat-3-label': 'ដឹកជញ្ជូនអន្តរជាតិ',
    'del-stat-4-label': 'ធានាសំណងការខូច',
    'cta-title': 'ត្រៀមបង្ហោះ<br/>តារភ្ជាប់ដែកគុណភាព?',
    'cta-desc': 'ទទួល Quotation ជាមួយ QC Report ក្នុងរយ:ណពេល 24 ម៉ោង',
    'cta-btn': 'សុំតម្លៃភ្លាមៗ',
    'contact-tag': 'ទំនាក់ទំនង', 'contact-title': 'ពាណិជ្ជកម្ម <em>ការសន្ទនា</em>',
    'contact-desc': 'មិនថាអ្នកត្រូវការ Quotation ភ្លែត ការផ្គត់ផ្គង់រយៈពេលវែង ឬវិស្វករព្រឹក្សា — ក្រុមប្រឹក្សានឹងឆ្លើយតបក្នុងមួយថ្ងៃការងារ',
    'contact-addr-label': 'អាសយដ្ឋានរោងចក្រ', 'contact-addr': 'CJJG+HHH, Khum Trapeang Kong, Cambodia',
    'contact-map-btn': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6-3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg> មើលលើ Google Maps',
    'contact-phone-label': 'ទូរស័ព្ទចែកចាយ', 'contact-email-label': 'អ៊ីមែល',
    'form-title': 'ផ្ញើស្នើសុំ', 'form-name': 'ឈ្មោះ', 'form-company': 'ក្រុមហ៊ុន',
    'form-company-ph': 'ឈ្មោះក្រុមហ៊ុនរបស់អ្នក', 'form-email': 'Email', 'form-phone': 'ទូរស័ព្ទ',
    'form-product': 'ផលិតផលដែលចាប់អារម្មណ៍', 'form-product-default': '— ជ្រើសផលិតផល —',
    'form-opt-1': 'តារភ្ជាប់ដែកជ្រួញ / ក្រឡសំណង់', 'form-opt-2': 'តារភ្ជាប់ជាន់',
    'form-opt-3': 'តារភ្ជាប់ Fence', 'form-opt-4': 'តារភ្ជាប់ ផ្ដាល់',
    'form-opt-5': 'ខ្សែដែក / Rod', 'form-opt-6': 'ផលិតផលចម្រុះ / ស្នើពិសេស',
    'form-detail': 'ស្នើស្ហ &amp; ស្បរលម្អិត',
    'form-detail-ph': 'សូមបញ្ជូក ស្តង់ ចន្លោះ ទំហំ mesh ចំនួន និងទីតាំងចែកចាយ…',
    'form-submit': 'ផ្ញើស្នើសុំ',
    'footer-about': 'ផ្ដោតលើការស្រាវជ្រាវ ផលិត និងលក់តារភ្ជាប់ដែកជ្រួញ — បម្រើសំណង់ ការសាងសង់ ការដឹកជញ្ជូន និងខ្សែឧស្សាហកម្ម ចាប់ផ្តើម 2002',
    'footer-col-1': 'ផលិតផល', 'footer-col-2': 'ក្រុមហ៊ុន', 'footer-col-3': 'ចុះឈ្មោះអ៊ីមែល',
    'footer-newsletter-desc': 'ចុះឈ្មោះ Newsletter ដើម្បីទទួលតម្លៃភ្លែត ផលិតផលថ្មី និងព័ត៌មានឧស្សាហកម្ម',
    'footer-email-ph': 'អ៊ីមែលរបស់អ្នក',
    'footer-cert': 'វិញ្ញាបនបត្រគុណភាព',
    'footer-copy': '© 2026 ក្រុមហ៊ុន Zhongyue Steel. រក្សាសិទ្ធិគ្រប់យ៉ាង។',
    'footer-privacy': 'គោលនយោបាយឯកជនភាព', 'footer-terms': 'លក្ខខ័ណ្ឌប្រើប្រាស់', 'footer-cert-link': 'វិញ្ញាបនបត្រ'
  }
};
...
(function() {
  ...
  var lang    = urlLang || saved || (browser.startsWith('en') ? 'en' : browser.startsWith('km') ? 'km' : 'zh');
  setLang(lang);
