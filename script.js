...
var i18nData = {
  zh: {
    ...
    'hero-badge': '专业钢筋网制造商 · 成立于 2002 年',
    'hero-h1': '铸就<em>钢铁</em><br/>品质<em>恒久</em>',
    'hero-tagline': '铸造力量，塑造未来。',
    'hero-desc': '中粤铁网公司深耕钢铁行业逾20年，精密生产焊接钢筋网，产品远销全球60余个国家与地区。',
    'hero-btn-products': '查看产品', 'hero-btn-process': '了解工艺', 'hero-btn-contact': '联系我们',
    'feat-1-title': '品质卓越', 'feat-1-desc': 'ISO 9001认证，每批附随完整质检报告',
    'feat-2-title': '技术领先', 'feat-2-desc': '全自动焊网生产线，日产能超800吨',
    'feat-3-title': '值得信赖', 'feat-3-desc': '20余年深耕行业，服务全球60余个国家与地区',
    'feat-4-title': '绿色生产', 'feat-4-desc': '清洁生产工艺，符合国际环保标准',
    ...
    'step-1': '原材料', 'step-1-sub': 'Wire Rod Ø3–12mm',
    'step-2': '调直切断', 'step-2-sub': 'Cold-Draw & Precision Cut',
    'step-3': '自动焊接', 'step-3-sub': '48-Head Simultaneous Weld',
    'step-4': '剪裁成型', 'step-4-sub': 'Custom Cut-to-Size',
    'step-5': '质量检验', 'step-5-sub': 'Tensile & Tolerance Tests',
    'step-6': '包装入库', 'step-6-sub': 'Strapped & Labeled',
    'step-7': '出厂交付', 'step-7-sub': 'Direct to Worksite',
    'about-tag': '关于中粤铁网', 'about-title': '品质<em>铸就</em><br/>信赖',
    'about-badge-text': '年<br/>专业经验',
    'about-year-label': '成立年份 · Founded',
    'about-live-label': '生产中 · Live',
    'about-lead': '自2002年成立以来，中粤铁网公司专注焊接钢筋网的研发与生产，以全自动焊接工艺、精密切断系统与严格质控流程，成为柬埔寨最具影响力的钢筋网制品供应商之一，产品出口全球60余个国家。',
    'about-f1-title': 'ISO 9001:2015 质量认证',
    'about-f1-desc': '每批产品均附随焊点抗拉强度、丝径公差、网格精度等全项检测报告，并附质量保证书与材质证明。',
    'about-f2-title': '全自动高速生产线',
    'about-f2-desc': '引进国际先进自动焊网机，定位精度±0.5mm，三班全天候运营，日产能超800吨。',
    'about-f3-title': '全球供应与物流',
    'about-f3-desc': '支持多种贸易条款（FOB/CIF），可直发全球60余个国家，提供报关、货运代理与保险一站式服务。',
    'fac-eyebrow-text': '实地工厂 · 柬埔寨工业园区',
    'fac-subtitle': '中粤铁网 · 实力工厂',
    'fac-desc': '坐落于柬埔寨工业园区，占地逾26,000㎡的现代化钢铁生产基地。<br/>全封闭厂区、智能安防、ISO认证车间——每一批产品均诞生于此。',
    ...
    'products-lead': '全系产品附随出厂质量证书，支持定制规格、线径及网格间距，可满足国标（GB/T）、欧标（EN）、美标（ASTM）等多种标准要求。',
    ...
    'why-lead': '全球工程师与采购团队信赖中粤铁网的六大核心理由。',
    'why-1-title': '出厂质量证书', 'why-1-desc': '每批附随焊点抗拉强度、丝径公差、网格精度等全项检测报告，全程可追溯。',
    'why-2-title': '准时交货', 'why-2-desc': '99% 按期履约率，自有车队配合港口战略合作，常规订单15个工作日内发货。',
    'why-3-title': '定制规格服务', 'why-3-desc': '支持按图纸定制线径、间距及网片尺寸，厂内技术工程师全程跟进。',
    'why-4-title': '工厂直供价格', 'why-4-desc': '省去中间环节，直厂报价更具竞争力，批量采购客户可享专属优惠。',
    'why-5-title': '全球供货能力', 'why-5-desc': '专职外贸团队，可提供FOB、CIF等多种贸易条款，覆盖60余个国家与地区。',
    'why-6-title': '全天候技术支持', 'why-6-desc': '专属客户经理与结构工程师7×24小时在线，提供选型建议及现场技术咨询。',
    ...
    'testi-3-name': '王海涛 / 项目工程师',
    'del-label': '准时交货', 'del-title': '高效物流 · <span>直达工地</span>',
    'del-desc': '从车间到工地，全程跟踪配送。自有重型货车车队覆盖柬埔寨及周边地区，确保钢筋网产品安全准时送达。',
    'del-badge-1': '批量发货', 'del-card-1-title': '整车发运 · 满载出库',
    'del-card-1-desc': '大吨位平板车满载钢筋网，单车可运输 20–30 吨产品',
    'del-badge-2': '区域配送', 'del-card-2-title': '专业车队 · 全程追踪',
    'del-card-2-desc': '覆盖柬埔寨全境及周边各省市工地，准时交付有保障',
    'del-stat-1-unit': '小时内', 'del-stat-1-label': '下单后发货时效',
    'del-stat-2-unit': '吨/车', 'del-stat-2-label': '单次最大装载量',
    'del-stat-3-unit': '+地区', 'del-stat-3-label': '覆盖配送区域',
    'del-stat-4-label': '货损赔付保障',
    'cta-title': '准备好采购<br/>优质钢筋网了吗？',
    'cta-desc': '24小时内回复，附随完整质检报告的正式报价单。',
    'cta-btn': '立即获取报价',
    'chat-tag': '在线客服', 'chat-title': '实时<em>咨询</em>', 'chat-lead': '有疑问？直接与我们的销售团队在线对话。',
    'contact-tag': '联系我们', 'contact-title': '商务<em>洽谈</em>',
    'contact-desc': '无论您需要即期报价、长期供货协议还是技术选型支持，我们的专业团队将在一个工作日内为您回复。',
    ...
    'footer-cert': '质量认证',
    'footer-copy': '© 2026 中粤铁网公司. 版权所有.',
    'footer-privacy': '隐私政策', 'footer-terms': '使用条款', 'footer-cert-link': '质量证书',
    'nav-gallery': '图片展示',
    'gallery-tag': '产品与工厂', 'gallery-title': '产品与<em>工厂展示</em>',
    'gallery-lead': '实景拍摄于我们的车间与成品区，所见即所得——产品品质，一目了然。',
    'gallery-cap-p1': '焊接钢筋网', 'gallery-cap-p2': '楼板钢筋网',
    'gallery-cap-p3': '焊接围栏网', 'gallery-cap-p4': '异型钢筋网',
    'gallery-cap-p5': '冷拔钢丝 / 盘条',
    'gallery-cap-m1': '自动焊网生产线', 'gallery-cap-m2': '钢丝调直机',
    'gallery-cap-m3': '品质检验', 'gallery-cap-m4': '包装工序',
    'gallery-cap-m5': '工厂设备', 'gallery-cap-m6': '生产车间',
    'gallery-cap-d1': '整车发运', 'gallery-cap-d2': '物流车队',
    'gallery-cap-fg': '工厂大门',
    'gallery-cap-gif1': '工厂实景展示', 'gallery-cap-gif2': '生产线实景',
    'fb-tag': '关注我们',
    'fb-badge-text': '官方认证主页',
    'fb-title': '关注<em>中粤铁网</em>',
    'fb-desc': '获取最新产品资讯、工厂动态及优惠活动。我们的销售团队通过 Facebook Messenger 直接回复询价，响应迅速。',
    'fb-btn-follow': '关注主页',
    'fb-btn-msg': 'Messenger 咨询',
    'fb-metric-1-val': '在线', 'fb-metric-1-label': '在线状态',
    'fb-metric-2-val': '24h内', 'fb-metric-2-label': '回复时效',
    'fb-metric-3-label': '服务国家',
    'fb-card-follow': '关注',
    'fb-card-msg': '消息',
    'fb-followers': '位粉丝',
    'fb-following': '正在关注',
    'fb-page-bio': 'ZY Steel（中粤铁网）是位于柬埔寨金边的钢丝网制造厂，产品涵盖焊接钢网、钢筋网片、围栏网及绑扎丝，工厂直供，支持定制。',
    'page-title': '中粤铁网公司 — 专业钢筋网制造商 | Zhongyue Steel',
    'meta-desc': 'Zhongyue Steel — 专业焊接钢筋网制造商，ISO 9001认证，线径3–12mm，服务全球60余个国家，2002年成立。',
  },
  en: {
    'topbar-addr': 'CJJG+HHH, Khum Trapeang Kong, Cambodia',
    'topbar-hours': 'Every Day, 8:00 – 17:00',
    ...
    'hero-badge': 'Professional Steel Mesh Manufacturer · Est. 2002',
    'hero-h1': 'Built for <em>Strength</em><br/>Made to <em>Last</em>',
    'hero-tagline': 'Building Strength. Shaping Tomorrow.',
    'hero-desc': 'Zhongyue Steel — 20+ years of precision welded rebar mesh manufacturing, trusted by contractors and engineers across 60+ countries.',
    'hero-btn-products': 'View Products', 'hero-btn-process': 'Our Process', 'hero-btn-contact': 'Contact Us',
    'feat-1-title': 'Certified Quality', 'feat-1-desc': 'ISO 9001 certified — full QC test reports on every batch',
    'feat-2-title': 'Advanced Technology', 'feat-2-desc': 'Fully automated welding lines, 800+ tonnes daily output',
    'feat-3-title': 'Trusted Partner', 'feat-3-desc': '20+ years of expertise, serving contractors in 60+ countries',
    'feat-4-title': 'Clean Production', 'feat-4-desc': 'Lean, low-waste manufacturing meeting international standards',
    'meta-years': 'Years of Experience', 'meta-cap': 'Daily Output (T)', 'meta-countries': 'Export Countries', 'meta-retention': 'Client Retention',
    ...
    'tl-lead': 'Seven precision steps with full quality traceability — every batch traceable from rod to delivery.',
    'step-1': 'Raw Material', 'step-1-sub': 'Wire Rod Ø3–12mm',
    'step-2': 'Straighten & Cut', 'step-2-sub': 'Cold-Draw & Precision Cut',
    'step-3': 'Auto Welding', 'step-3-sub': '48-Head Simultaneous Weld',
    'step-4': 'Cut to Size', 'step-4-sub': 'Custom Dimensions',
    'step-5': 'QC Inspection', 'step-5-sub': 'Tensile & Tolerance Tests',
    'step-6': 'Packaging', 'step-6-sub': 'Strapped & Labeled',
    'step-7': 'Delivery', 'step-7-sub': 'Direct to Worksite',
    'about-tag': 'About Zhongyue Steel', 'about-title': 'Quality <em>Built</em><br/>to Last',
    'about-badge-text': 'Years of<br/>Expertise',
    'about-year-label': 'Founded · Est.',
    'about-live-label': 'Live Production',
    'about-lead': 'Since 2002, Zhongyue Steel has focused exclusively on welded rebar mesh — building fully automated production lines, precision cutting systems, and a rigorous QC process. Today we are one of Cambodia\'s leading steel mesh manufacturers, exporting to clients across 60+ countries.',
    'about-f1-title': 'ISO 9001:2015 Certified',
    'about-f1-desc': 'Every batch ships with a full test report: weld tensile strength, wire diameter tolerance, and mesh spacing accuracy — plus a quality certificate and material certificate.',
    'about-f2-title': 'Fully Automated High-Speed Lines',
    'about-f2-desc': 'State-of-the-art automatic mesh welding machines with ±0.5mm positioning accuracy. Three-shift, 24/7 operation delivers over 800 tonnes per day.',
    'about-f3-title': 'Global Supply & Logistics',
    'about-f3-desc': 'Direct export to 60+ countries. FOB, CIF, and other trade terms available. One-stop customs clearance, freight forwarding, and cargo insurance.',
    'fac-eyebrow-text': 'Our Facility · Cambodia Industrial Zone',
    'fac-subtitle': 'Zhongyue Steel · Built for Scale',
    'fac-desc': 'A modern steel production base covering over 26,000㎡ in Cambodia\'s industrial zone.<br/>Fully enclosed campus, smart security, ISO-certified workshops — every batch leaves from here.',
    ...
    'fact-1': 'Daily Output (T)', 'fact-2': 'Export Countries', 'fact-3': 'Employees', 'fact-4': 'Industry Awards',
    'why-tag': 'Why Choose Us', 'why-title': 'Six Reasons to <em>Choose Zhongyue</em>',
    'why-lead': 'Here is why procurement teams and engineers across 60+ countries specify Zhongyue Steel.',
    'why-1-title': 'Factory Quality Certificate', 'why-1-desc': 'Every batch ships with test reports: weld tensile strength, wire diameter tolerance, and mesh accuracy — fully traceable.',
    'why-2-title': 'On-Time Delivery', 'why-2-desc': '99% on-time fulfillment. Own fleet plus port partnerships — standard orders ship within 15 business days.',
    'why-3-title': 'Custom Specifications', 'why-3-desc': 'Custom wire diameter, mesh spacing, and panel size to your drawings. In-house engineers support you throughout.',
    'why-4-title': 'Factory-Direct Pricing', 'why-4-desc': 'No middlemen — direct factory quotes save you money. Volume buyers receive additional discounts.',
    'why-5-title': 'Global Supply', 'why-5-desc': 'Dedicated export team offering FOB, CIF, and other trade terms. We handle customs, freight, and documentation.',
    'why-6-title': '24/7 Technical Support', 'why-6-desc': 'Dedicated account managers and structural engineers available around the clock for product selection and on-site advice.',
    ...
    'testi-3-name': 'Wang Haitao / Project Engineer',
    'del-label': 'On-Time Delivery', 'del-title': 'Efficient Logistics · <span>Direct to Site</span>',
    'del-desc': 'From workshop to worksite — fully tracked every step. Our heavy-duty truck fleet covers Cambodia and surrounding regions, delivering steel mesh safely and on schedule.',
    'del-badge-1': 'Bulk Dispatch', 'del-card-1-title': 'Full Truckload · Ready to Ship',
    'del-card-1-desc': 'Heavy flatbed trucks fully loaded with steel mesh panels — 20–30 tonnes per trip',
    'del-badge-2': 'Regional Coverage', 'del-card-2-title': 'Professional Fleet · Full Tracking',
    'del-card-2-desc': 'Covering Cambodia and all surrounding provinces — on-time delivery, guaranteed',
    'del-stat-1-unit': 'Hours', 'del-stat-1-label': 'Dispatch after order',
    'del-stat-2-unit': 'T / Truck', 'del-stat-2-label': 'Max load per trip',
    'del-stat-3-unit': '+ Regions', 'del-stat-3-label': 'Coverage area',
    'del-stat-4-label': 'Cargo damage guarantee',
    'cta-title': 'Ready to Source<br/>Quality Steel Mesh?',
    'cta-desc': 'Receive a formal quotation with full QC documentation within 24 hours.',
    'cta-btn': 'Get a Quote Now',
    'chat-tag': 'Live Chat', 'chat-title': 'Talk to <em>Us Now</em>', 'chat-lead': 'Have a question? Connect directly with our sales team in real time.',
    'contact-tag': 'Contact Us', 'contact-title': 'Business <em>Inquiries</em>',
    'contact-desc': 'Need an immediate quote, a long-term supply agreement, or technical guidance? Our team replies within one business day.',
    ...
    'footer-about': 'Trusted by contractors and engineers across 60+ countries — ISO 9001 certified welded rebar mesh, manufactured in Cambodia since 2002.',
    ...
    'gallery-lead': 'Shot on-site — every product and machine you see is real, running in our facility today.',
    ...
    'gallery-cap-gif1': 'Factory Live View', 'gallery-cap-gif2': 'Production Line Live',
    'fb-tag': 'Follow Us on Facebook',
    'fb-badge-text': 'Official Facebook Page',
    'fb-title': 'Follow <em>ZY Steel</em>',
    'fb-desc': 'Get the latest product updates, factory news, and special offers. Our sales team replies to inquiries directly on Facebook Messenger.',
    'fb-btn-follow': 'Follow Page',
    'fb-btn-msg': 'Message Us',
    'fb-metric-1-val': 'Active', 'fb-metric-1-label': 'Page Status',
    'fb-metric-2-val': 'Within 24h', 'fb-metric-2-label': 'Reply Time',
    'fb-metric-3-label': 'Countries Served',
    'fb-card-follow': 'Follow',
    'fb-card-msg': 'Message',
    'fb-followers': 'followers',
    'fb-following': 'following',
    'fb-page-bio': 'ZY Steel (中粤钢铁) is a steel wire mesh factory in Phnom Penh, Cambodia. We manufacture welded wire mesh, rebar mesh, fence mesh and binding wire — factory-direct prices, custom orders.',
